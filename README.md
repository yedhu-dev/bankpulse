...
[06-09-2026 12:54 AM] Valentino: # BankPulse – Banking Transaction Analysis
...
- Compare account types, transaction types, and banking channels
- Analyze fraudulent transactions
- Create useful summaries using advanced SQL techniques
...
- The total transaction amount for January 2019 is approximately ₹12.39 million.
- The average transaction amount is approximately ₹20,726.
- Fraudulent transactions can be analyzed across different banking channels.
- Customer and account-level rankings help identify high-value transaction activity.
- Monthly analysis provides an overview of transaction trends in the dataset.

## 9. How to Run the Project

1. Open MySQL Workbench.
2. Create or select the bankpulse database.
3. Use the schema file from the schema folder to create the bank_transactions table.
4. Import the CSV dataset into the bank_transactions table.
5. Run the SQL files from the queries folder.
6. Review the query results in MySQL Workbench.
7. The screenshots in the screenshots folder provide examples of selected query results.
...
├── schema/
│   └── create_tables.sql
[06-09-2026 12:54 AM] Valentino: ├── queries/
│   ├── 01_beginner_questions.sql
│   ├── 02_intermediate_questions.sql
│   └── 03_advanced_questions.sql
└── screenshots/
